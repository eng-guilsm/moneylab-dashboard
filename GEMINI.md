...
* **Trava 2.7 (Corredor Dinâmico de Dólar USDT — Piso 30% / Teto 60% com Blindagem Anti-Zeragem):**
  * **Piso Estrutural de 30% (Colchão Defensivo Simple Earn a 6,88% a.a.):** No mínimo 30% do patrimônio consolidado dinâmico apurado em tempo real permanece obrigatoriamente alocado em Dólar USDT (com transição para 40% a 50% após novos aportes de capital). Nenhuma ordem de venda para BRL ou compra de ações pode reduzir a custódia total de USDT abaixo desse piso, **garantindo matematicamente que o valor em dólares NUNCA zera**.
...
* **Trava 2.8 (Corredor Dinâmico de Caixa Fiduciário BRL — Piso 10% / Teto 25%):**
  * **Piso de Caixa de 10% (Reserva de Oportunidade Anti-Pânico):** No mínimo 10% do patrimônio consolidado permanece preservado em Reais (BRL) para garantir liquidez instantânea na compra de fundos e dips de Bitcoin, Solana, BNB e LINK. Nenhuma compra em Reais pode furar esse piso.
  * **Teto de Caixa de 25% (Combate à Ociosidade Fiduciária):** Como o saldo em Reais na corretora tem rendimento de 0% a.a., se o caixa fiduciário exceder 25% da carteira, novas entradas em Reais são priorizadas para dolarização via Pátria Volátil em direção ao Simple Earn (6,88% a.a.).
...
| :-: | :--- | :---: | :---: | :--- | :--- |
| **1** | **Plano Guiana Brasileira** | PAXG <-> BTC | 150 reais | Arbitragem intradiária de spread adaptativo PAXG/BTC com Z <= -0,50. Preserva corredor dinâmico de ouro (Piso 10% / Teto 20%). | Ativo (Recalibrado) |
...
| **5** | ⭐ **Plano Ouro Líquido** | USDT <-> PAXG | 155 reais | Arbitragem intradiária de spread adaptativo PAXG/USDT (Lote 30 USDT / Trava 6 >= +0,60%). Lucro: **+4,57 reais/mês (+0,225%/m)**. Preserva corredor de ouro (Piso 10% / Teto 20%). | Ativo (Homologado) |
...
| **15** | 🎩 🚪 **Plano Adeus, Perry** | PAXG/Legados -> USDT/BRL | Tranche 35 USDT | Desova cirúrgica de excesso de Ouro PAXG acima de 20% em tranches de 35 USDT (~180 reais) sob Trava 6 (>= +0,40% sobre VWAP de 23.576 BRL) para USDT Simple Earn (6,88% a.a.), além de desova de legados. | Ativo (Desova de Excesso sob Lucro) |
| **16** | 🏺 🧪 **Plano Caboclo dos Oráculos** | BRL <-> LINK | 180 reais | Mean-reversion 10h com Inflexão de Sagarana (Z <= -0,80, d2Z >= +0,010, Trava 6 >= +0,80%). Lucro: **+3,49 reais/mês (+0,160%/m)**. | 🧪 **Ativo em Simulação** |
